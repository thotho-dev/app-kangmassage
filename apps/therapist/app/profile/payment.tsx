    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.container}>
        ...
        <View style={[styles.header, { backgroundColor: t.headerBg }]}>
          ...
          <Text style={[styles.title, { color: '#FFFFFF' }]}>Rekening Pencairan</Text>
          <Text style={[styles.subtitle, { color: 'rgba(255,255,255,0.7)' }]}>Kelola rekening untuk menarik pendapatan</Text>
        </View>
