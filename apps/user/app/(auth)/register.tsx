...
const styles = StyleSheet.create({
  ...
  primaryBtn: {
    alignItems: 'center', justifyContent: 'center', paddingVertical: 14, borderRadius: 24, marginTop: 6,
    elevation: 6, shadowColor: COLORS.gold[500],
    shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 10,
  },
  primaryBtnText: { fontSize: 13, fontFamily: 'PlusJakartaSans-Bold', color: '#FFFFFF' },
  fieldLabel: { fontSize: 12, fontFamily: 'PlusJakartaSans-Medium', marginBottom: 6 },
  inputWrap: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    borderRadius: 16, borderWidth: 1.5, paddingHorizontal: 16, height: 48, marginBottom: 16,
  },
