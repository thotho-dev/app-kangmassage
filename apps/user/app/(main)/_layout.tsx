...
function AnimatedTabItem({
  ...
  return (
    ...
    >
      {/* Pill content + background as one self-centering unit */}
      <Animated.View style={[styles.pill, contentStyle]}>
        {/* Background — absolute fill, opacity-animated (zero threshold issues) */}
...
const styles = StyleSheet.create({
  ...
  pill: {
    ...
    borderRadius: 24,
    overflow: 'hidden',
    alignSelf: 'center',   // shrink-wrap to content, centered in tabItem
  },
  pillBg: {
